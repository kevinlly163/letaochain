...
unsigned char pchMessageStart[4] = { 0xf7, 0xe6, 0x2b, 0x7d};
int64 nChainStartTime = 1512527001;
...
const string strMessageMagic = "Letaochain Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Letaochain
    bool fStrictPayToScriptHash = true; // Always active in Letaochain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Letaochain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017.12.6-Letaochain is Release ,wish is a great Coin,wish is a great Coin";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x58423dd31bd8c7217e60545f7a684f32fa8e58368951ab6db84459726d6ccaec"));
